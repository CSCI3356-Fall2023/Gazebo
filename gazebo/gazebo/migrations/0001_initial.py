# Generated by Django 4.2.6 on 2023-12-14 00:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_level', models.CharField(default='', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('course_number', models.CharField(default='', max_length=10)),
                ('course_type', models.CharField(choices=[('lecture', 'Lecture'), ('lab', 'Lab'), ('discussion', 'Discussion')], max_length=10)),
                ('section_number', models.CharField(max_length=10)),
                ('section_id', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('instructor', models.CharField(max_length=255)),
                ...
                ('period_of_day', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='gazebo.section')),
